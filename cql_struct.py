...
def global_table_spec_func(ctx):
    print("ctx for global_table_spec_func", ctx)
    return ctx.flags & ResultRowsFlags.GLOBAL_TABLES_SPEC and not ctx.flags & ResultRowsFlags.NO_METADATA
...
result_rows = construct.Struct(
    ...
    "metadata" / construct.Struct(
        ...
        "global_table_spec" / construct.If(global_table_spec_func, string_list),
...
#print(frame.parse(hexstring_to_bytes("""
