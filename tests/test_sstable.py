...
def test_cells():
    test_cells = [simple_cell_example, complex_cell_list_item_example, complex_cell_set_item_example, complex_cell_example, complex_row_body_example, simple_row_body_example, simple_unfiltered_example, simple_cell_third_column_example]
